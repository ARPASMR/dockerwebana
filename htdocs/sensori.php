<?php
    ...
    elseif($toDo=="dettaglio"){
        ...
        if($IDsensore==''){
            ...
            print '<h2>Specifiche Strumenti</h2>
                    <table class="lista">
	    ...
	    // Visualizza storico delle Destinazioni
            ...
            $destinazioni->getBySensore($IDsensore);
            print '<h2>Destinazioni</h2>
                   <table class="lista tablesorter">
                    '.$destinazioni->printListTable($IDsensore).'
                   </table>';
            unset($destinazioni);
