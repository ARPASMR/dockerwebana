<?php
    ...
    class Stazione extends GenericEntity {
        ...
        public function printListTable($params) {
            ...
            $output = '<p style="text-align: left; background-color: #FFFFB8; border-width: 1px; border-style: solid; border-bottom-style: none; border-color: Black;"><i>' . $numItems . ' stazioni trovate.</i></p>';
